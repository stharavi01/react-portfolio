...
const Experience = () => {
	return (
		<section id="experience" className="w-full h-full  bg-lightBlack ">
			{/* Vertical Timeline */}
			<div className="text-lg text-lightWhite leading-none py-12">
				<h2 className="font-MontrealBold text-lightWhite font-light text-[3rem] border-b border-white mx-16 mb-16 pb-12 leading-none tracking-loose uppercase">
					My Experience
				</h2>
